...
environmental_justice = c('Environmental justice','environmental justice','EJ','socioeconomic','low-income','minority',
...
sent_df$X_Sociocultural <- grepl(paste(paste0("\\b",sociocultural_words,"\\b"),collapse='|'),sent_df$text) + 0 
...
wiki_pages = c("baseball","American_Revolution","genetics","airplane","stock_market","Administrative_law",
               "LeBron_James","Star_Trek",'geology','beer')
...
none_df = none_df[sample(1:nrow(none_df),20000,replace=T),]
