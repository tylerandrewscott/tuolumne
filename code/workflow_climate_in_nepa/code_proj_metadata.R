...
projs$PROJECT_TOPIC[grepl('Highway|Rail|Transportation|Transit',projs$Lead.Agency)|grepl('Airport|Proposed New Bridge|Rail Support Facility|Kinston Bypass|US-275|Nebraska Highway 12|Intermodal Container Transfer Facility|Bog Creek Road Project',projs$Title)] <- 'Transportation'
projs$PROJECT_TOPIC[grepl('United States Army|Navy|Air Force|Marine Corp|Space',projs$Lead.Agency)|grepl('SpaceX|Spaceport|Plutonium Pit Production|NIH Chilled Water System|Interceptor Site|Radioisotope|Research Program Facility|Polar Icebreaker|Geologic Repository|Public Safety Broadband|Spent Nuclear Fuel|Waste Confidence|Early Site Permit|Determinations of Nonregulated Status|Determination of Non-regulated|Determination of Nonregulated Status|Genetically Engineered|Sheep Analysis|Experimental Forest|Research Station Project',projs$Title)] <- 'Military, Space & Research'
...
projs$PROJECT_TOPIC[projs$Agency=='Forest Service'&grepl('Management Plan|Plan Amendment|Plan Revision|Vegetation Management Project|Salvage|Revised Forest Plan|Forest Management Project|Late-Successional Reserve',projs$Title)] <- 'Forestry'

projs$PROJECT_TOPIC[grepl('Canal\\b|Water Resources|Ship Channel|River System Operations|Container Terminal Improvements|Upper Barataria Basin|Lake Pontchartrain and Vicinity|Rockaway Inlet and Jamaica Bay|West Bank and Vicinity|Blanchard River Watershed Study|Shoreline Stabilization|Mobile Harbor|Shallow Flow Equalization Basin|South San Francisco Bay Shoreline Phase I|River Basin Project|Berryesssa Creek Project|Southport Sacramento|Lower San Joaquin River Project|Coastal Storm Risk Management|Beach Nourishment|Navigation Study|Flood Damage Reduction|Navigation Feasibility|Dredged Material Management Plan|West Sacramento Project|Water Control Manual|Watery System|Dam Safety|Cherry Point Dock|Dike Dam|Gulfport Expansion|American River Common Features|Harbor Post|Flood Risk Management|Floodway|Harbor Navigation|Water Transfers|Water Supply Project|Deepwater Port|Southern Flow Corridor Project|Discharge Project|San Luis Low Point|Regional Water System|Rio Grande Project|Salinity Control Program|Pure Water San Diego|Basin Feasibility|Alternate Water Supply|Water Shortage|Central Arizona Project|Locks\\b|Levee|Sisk Dam|Glen Canyon Dam|Recycled Water|Central Valley Project|Basin Storage|Storm Damage|Diversion|Lock\\b|Collection System|Gulf Outlet|Channel Improvement|Embarkation|Pier Replacement|Dredging|Harbor Project|Flood Control|Reservoir',projs$Title)] <- 'Public Works'
...
projs$PROJECT_TOPIC[projs$Title %in% c("Townsend Project", "Magone Project" ,"South Revilla Integrated Resource Project","Hwy 46 Project","Rulemaking for Alaska Roadless Areas",
                                       ...
                                       "Medicine Bow Landscape Vegetation Analysis (LaVA) Project","Beasley Pond Analysis Area" ,
